...
from interface.utility import end_session, return_code
...
class InterfaceTest(unittest.TestCase):
    ...
    def _test_add_restaurant(self):
        ...
        self.assertEqual(code, return_code["OK"])
        ...
        self.assertEqual(code, return_code["RESTAURANT_EXIST"])
        self.assertEqual(res, None)
        code, res = add_restaurant("", "b", "p1", 1, "", [])
        self.assertEqual(code, return_code["INVALID_DATA"])
        self.assertEqual(res, None)
    ...
    def _test_delete_restaurant(self):
        ...
        self.assertEqual(res, None)
        code, res = delete_restaurant(4)
        self.assertEqual(code, return_code["RESTAURANT_NOT_EXIST"])
        self.assertEqual(res, None)
    ...
    def _test_add_tag(self):
        ...
        self.assertEqual(res, None)
        code, res = add_tag("t1")
        self.assertEqual(code, return_code["TAG_EXIST"])
        self.assertEqual(res, None)
    ...
    def _test_delete_tag(self):
        ...
        self.assertEqual(res, None)
        code, res = delete_tag(3)
        self.assertEqual(code, return_code["TAG_NOT_EXIST"])
        self.assertEqual(res, None)
